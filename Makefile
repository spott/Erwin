...
SOURCES=${basis_src} ${hamiltonian_src}
...
testing/test_basis: ${basis_objects}  chkopts
	-${CLINKER} -o $@ ${basis_objects} ${LDFLAGS} ${PETSC_VEC_LIB} ${SLEPC_LIB}

testing/test_hamiltonian: ${hamiltonian_objects}  chkopts
	-${CLINKER} -o $@ ${hamiltonian_objects} ${LDFLAGS} ${PETSC_VEC_LIB} ${SLEPC_LIB}
